@php
    ...
    $tabs = $user->role === \App\Enums\UserRole::SUPER_ADMIN
        ...
        : [
            ...
            ['route' => 'sales.index', 'label' => 'Ventes', 'icon' => 'cart'],
...
>
    <div class="grid h-16" style="grid-template-columns: repeat({{ count($tabs) + 1 }}, minmax(0, 1fr));">
        @foreach ($tabs as $tab)
    ...
    >
        ...
        @endunless
        @if (in_array($user->role, [\App\Enums\UserRole::ADMIN_COMPANY, \App\Enums\UserRole::OUTLET_MANAGER]))
